...
Global Title.s = "Photograph Database"
Global Version.s = "1.0.0"
Global Author.s = "collectordave"
Global ProgramLanguage.s = "Pure Basic 5.5"
Global BaseFolder.s
Global SlideTime.i
Global Language.s
Global Move.i  
...
EndProcedure
  ...
  Procedure.i Message(Title.s,Msg.s,Flags.i)
    ...
    If Flags & #YesNoCancel > 0
      btn1 = ButtonGadget(#PB_Any, 130, gHeight + 10, 80, 30, "Yes")
      btn2 = ButtonGadget(#PB_Any, 220, gHeight + 10, 80, 30, "No")
      btn3 = ButtonGadget(#PB_Any, 310, gHeight + 10, 80, 30, "Cancel")
    ElseIf   Flags & #OkCancel > 0
      btn2 = ButtonGadget(#PB_Any, 220, gHeight + 10, 80, 30, "Ok")
      btn3 = ButtonGadget(#PB_Any, 310, gHeight + 10, 80, 30, "Cancel")
    ElseIf   Flags & #YesNo > 0
      btn2 = ButtonGadget(#PB_Any, 220, gHeight + 10, 80, 30, "Yes")
      btn3 = ButtonGadget(#PB_Any, 310, gHeight + 10, 80, 30, "No")
    Else
      btn3 = ButtonGadget(#PB_Any, 310, gHeight + 10, 80, 30, "Ok")
    EndIf
...
EndProcedure
  ...
  Procedure ReadPreferences(AppName.s)
    ...
    App::Title =  ReadPreferenceString("Title","Photograph Database")   
